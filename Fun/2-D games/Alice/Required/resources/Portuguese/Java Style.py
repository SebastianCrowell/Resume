...
formatMap = {
	...
	edu.cmu.cs.stage3.alice.core.response.MoveTowardAnimation : "<<<subject>>>.movaPara( <target>, <amount> );",
	edu.cmu.cs.stage3.alice.core.response.MoveAwayFromAnimation : "<<<subject>>>.movaAfastandoDe( <target>, <amount> );",
	...
	edu.cmu.cs.stage3.alice.core.response.PointAtConstraint : "<<<subject>>>.restringidoParaApontar( <target> );",
	...
	edu.cmu.cs.stage3.alice.core.response.ScriptDefinedResponse : "respostaDefinidaPorRoteiro( <script> );",
	...
	edu.cmu.cs.stage3.alice.core.response.vector3.SetX : "<<<vector3>>>.definaDistânciaADireita( <value> )",
	edu.cmu.cs.stage3.alice.core.response.vector3.SetY : "<<<vector3>>>.definaDistânciaAcima( <value> )",
	edu.cmu.cs.stage3.alice.core.response.vector3.SetZ : "<<<vector3>>>.definaDistânciaAFrente( <value> )",
...
nameMap = {
	...
	"edu.cmu.cs.stage3.alice.core.behavior.MouseButtonIsPressedBehavior" : "Enquanto <mouse> é pressionado <onWhat>",
	...
	"edu.cmu.cs.stage3.alice.core.behavior.MouseLookingBehavior" : "Deixer <mouse> orientar a câmera",
	"edu.cmu.cs.stage3.alice.core.behavior.SoundMarkerPassedBehavior" : "Quando o som marcado <marker> é tocado",
	"edu.cmu.cs.stage3.alice.core.behavior.SoundLevelBehavior" : "Quando o nível de gravação do som é >= <level>",
